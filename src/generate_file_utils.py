...
def generate_files_recursive(dir_path_content, template_path, dest_dir_path):
    ...
    for x in all_items:
        ...
        if os.path.isfile(source_path):
            ...
            generate_file(source_path, template_path, write_path)
        if os.path.isdir(source_path):
            os.mkdir(destination_path)
            generate_files_recursive(source_path, template_path, destination_path)
